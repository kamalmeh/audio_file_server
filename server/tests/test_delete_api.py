...
from server.views import CreateAudioResource, DeleteAudioResource
    ...
    def test_delete_001(self):
        ...
        if self.assertEqual(response.status_code, 200):
            request = self.client.get(
               "/server/delete/song/1/",
            ).wsgi_request
            response = DeleteAudioResource.as_view()(request)
